...
onCalculate = (event) => {
    this.setState({
        Bench: this.oneRepMax(parseInt(this.refs.BenchWeight.value), parseInt(this.refs.BenchReps.value)),
        Overhead: this.oneRepMax(parseInt(this.refs.OverheadWeight.value), parseInt(this.refs.OverheadReps.value)),
        Deadlift: this.oneRepMax(parseInt(this.refs.DeadliftWeight.value), parseInt(this.refs.DeadliftReps.value)),
        Squat: this.oneRepMax(parseInt(this.refs.SquatWeight.value), parseInt(this.refs.SquatReps.value))
    })     
}
        ...
        if (this.state.Bench) {
            return (
                <div>
                  ...
                  <button type="button" className="btn btn-primary" onClick={event => this.FillinStats(event)}>
